...
export type SignInMutation = { __typename?: 'RootMutationType', signIn?: { __typename?: 'SignInPayload', token: string, userId: string, user: { __typename?: 'User', address: string, cpf: string, email: string, name: string } } | null };
