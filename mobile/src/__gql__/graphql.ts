...
export type GetMeQuery = { __typename?: 'RootQueryType', me?: { __typename?: 'MePayload', token: string, id: string, userId: string, user: { __typename?: 'User', id: number, name: string, address: string, email: string, cpf: string, insertedAt: any, updatedAt: any, passwordHash: string } } | null };
